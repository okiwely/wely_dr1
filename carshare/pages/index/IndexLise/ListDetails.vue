				...
				<view class="flex" style="margin:0 auto  2.372rem;width:139.13rem;">
					<view style="width:104.98rem;margin:0  3.162rem 0 0;">
						...
						<view
							...
							<view style="text-align: right;font-size: 1.264rem;color: #666666;">ドライブ登録日</view>
						</view>
					</view>
				...
				<view class="flex" style="margin:0 auto  2.372rem;width:139.13rem;">
					<view style="width:100vw;margin:0  3.162rem 0 0;">
						...
						<view
							...
							<view style="text-align: right;font-size: 2.2rem;color: #666666;">ドライブ登録日</view>
						</view>
					</view>
