...
//        tbCustomerChatMapper.insertTbCustomerChat(tbCustomerChat);
    ...
    public AjaxResult register(JSONObject jsonObject)
    {
        ...
        if (object != null && StringUtils.isNotBlank(object.getString("email"))) {
            ...
            jsonObject.put("avatar",jsonObject.getString("avatar") != null ? jsonObject.getString("avatar") : "https://kafeizulinbucket.oss-cn-beijing.aliyuncs.com/1727331548819.png");
            jsonObject.put("name",jsonObject.getString("name") != null ? jsonObject.getString("name") : "https://kafeizulinbucket.oss-cn-beijing.aliyuncs.com/1727331548819.png");
