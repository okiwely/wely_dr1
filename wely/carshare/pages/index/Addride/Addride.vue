		...
		<view class="content">
			...
			<view class='pc-only'>
				...
				<view v-if="type==2" class="flexJusp"
					...
					<view>
						<view style="font-size: 3.478rem;margin-bottom:1rem">￥{{price}}</view>
						<view style="font-size: 1.281rem;margin-bottom:0.5rem">●募集金額の内訳</view>
						<view style="font-size: 1.281rem;margin-bottom:0.5rem">●移動実費　{{Math.floor(price*0.8)}}円</view>
						<view style="font-size: 1.281rem;margin-bottom:0.5rem">●Wely手数料　{{Math.floor(price*0.2)}}円（20％）
						</view>
			...
			<view class='mobile-only'>
             ...
             <!--   <view
				...
				<view v-if="type==2" class="flexJusp"
					...
					<view>
						<view style="font-size: 4.15rem;margin-bottom:1rem">￥{{price}}</view>
						<view style="font-size: 2.85rem;margin-bottom:0.5rem">●募集金額の内訳</view>
						<view style="font-size:  2.85rem;margin-bottom:0.5rem">●移動実費　{{Math.floor(price*0.8)}}円</view>
						<view style="font-size:  2.85rem;margin-bottom:0.5rem">●Wely手数料　{{Math.floor(price*0.2)}}円（20％）
						</view>
