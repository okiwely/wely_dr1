			...
			<view class="flexJusp" style="align-items: center;margin:0  3.32rem 0 6.087rem;height: 7.905rem;">
				...
				<view v-if="customerId" class="flex" style="align-items: center;margin-right:6.798rem;">
					...
					<image @click="personal"
						...
						:src="Informations.avatar||'/static/logo.png'"></image>
...
<script>
	export default {
		...
		methods: {
			...
			welys() {
				location.href =
					"https://www.canva.com/design/DAGRWwFkIIg/kfoDOBL_S1a2xju-6vX90g/view?utm_content=DAGRWwFkIIg&utm_campaign=designshare&utm_medium=link&utm_source=editor";
			},
			personal() {
				uni.navigateTo({
