...
public class StringUtil {
    ...
    public static String simpleEncrypt(String str) {
        if (str != null && str.length() > 0) //noinspection AlibabaRemoveCommentedCode,AlibabaRemoveCommentedCode,AlibabaRemoveCommentedCode
        {
    ...
    public static String replaceBlank(String str) {
        if (str != null) {
            ...
            @SuppressWarnings("AlibabaAvoidPatternCompileInMethod") Pattern p = Pattern.compile("\\s*|\t|\r|\n");
    ...
    public static String[] getStringArrayByPattern(String str, String pattern) {
        ...
        while (matcher.find()) {
            for (int i = 0; i < matcher.groupCount(); i++) //noinspection AlibabaRemoveCommentedCode
            { // int groupCount()
                // 返回当前查找所获得的匹配组的数量。
     ...
     * *************************************************************************
     *
     * @param str 传入 &#31119;test&#29031;&#27004;&#65288;&#21271;&#22823;&#38376;&# 24635 ;&#24215;&#65289;&#31119;
     * @return 经过解码的内容
     * ************************************************************************
     * @author 李锋 2007.4.18
     */
    ...
    public static String[] stringToSet(String strs) {
        return StringUtil.isNotBlank(strs) ? strs.contains(",") ? strs.split(",") : new String[]{strs} : new String[]{};
    }

    public static List<String> stringBuilderToList(StringBuilder stringBuilder) {
        return stringBuilder != null ? Arrays.asList(stringBuilder.toString().split(",")) : new ArrayList<String>();
    }
     ...
     * @return
     */
    public static boolean validates(String price) {
        String num = price.substring(price.length() - 1, price.length());
        if ("0".equals(num)) {
            return true;
        }
        if (".".equals(num)) {
    ...
    public static Date StringToDate(String date) throws ParseException {
        SimpleDateFormat simpleDateFormat = new SimpleDateFormat("yyyy-MM-dd");
        return StringUtil.isNotBlank(date) ? simpleDateFormat.parse(date) : new Date();

    }

    /**
     * 时间格式化："yyyy-MM-dd HH:mm:ss"转Date形式
     *
     * @param date
     * @return
     */
     ...
     */
    @SuppressWarnings("AlibabaLowerCamelCaseVariableNaming")
    public static Date DateToStartByString(String sDate, Date startDate) throws ParseException {
        int index = sDate.indexOf(" ");
        sDate = sDate.substring(0, index);
        sDate = sDate.concat(" 00:00:00");
        startDate = StringToDateTime(sDate);
        return startDate;
    }

    /**
     * 时间格式化："yyyy-MM-dd 23:59:59"
     *
     * @param eDate
     * @param endDate
     * @return
     ...
     */
    @SuppressWarnings("AlibabaLowerCamelCaseVariableNaming")
    public static Date DateToEndByString(String eDate, Date endDate) throws ParseException {
        int index = eDate.indexOf(" ");
        eDate = eDate.substring(0, index);
        eDate = eDate.concat(" 23:59:59");
        endDate = StringToDateTime(eDate);
        return endDate;
    }
    ...
    public static boolean isBlank(Object object) {
        return StringUtil.isBlank(String.valueOf(object)) ? true : false;
    }
    ...
    public static boolean isNotBlank(Object object) {
        return StringUtil.isNotBlank(String.valueOf(object)) ? true : false;
    }
     ...
     * @return
     */
    public static String zeroFill(String dateTime) {
        String[] dateTimes = dateTime.split("-");
        if (dateTimes[1].length() == 1) {
            dateTimes[1] = "0".concat(dateTimes[1]);
        }
        return dateTimes[0].concat("-").concat(dateTimes[1]).concat("-").concat(dateTimes[2]);
    }
     ...
     * @param data
     */
    public static Map<String, Object> getSortAndOrder(Map<String, Object> sortMap, String data) {
        String sort = "sort";
        String order = "asc";
    ...
    public static String valueOf(Object content) {
        return content == null || content == "" ? "" : content.toString();
    }
    ...
    public static String replace(String str) {
        return isBlank(str) ? "" : str.replace("{", "").replace("}", "").replace(",", "&").replace(" ", "");
    }
